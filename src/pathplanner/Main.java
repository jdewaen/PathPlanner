...
//      world.addRegion(new Obstacle2D(new Pos2D(18, 0), new Pos2D(20, 13), 14, 19));
    ...
    public static List<Scenario2D> sphereBenchmarkEquivalent(Vehicle vehicle, World2D world){
      ...
      checkpoints.add(new Pos2D(1, 7));
      checkpoints.add(new Pos2D(1, 9));
      checkpoints.add(new Pos2D(1, 11));
      checkpoints.add(new Pos2D(1, 13));
          
      
      
      checkpoints.add(new Pos2D(1.5, 13.5));
      checkpoints.add(new Pos2D(3, 14));
      checkpoints.add(new Pos2D(4.5, 13.5));

      checkpoints.add(new Pos2D(5, 13));
      checkpoints.add(new Pos2D(5, 11));
      checkpoints.add(new Pos2D(5, 9));
      checkpoints.add(new Pos2D(5, 7));
      checkpoints.add(new Pos2D(5, 5));
      checkpoints.add(new Pos2D(5, 3));
